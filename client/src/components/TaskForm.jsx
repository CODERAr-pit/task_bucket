...
const CreateTaskForm = () => {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const taskData = {
        ...
        domain: form.domain,
        assignedTo: form.assignedTo.length > 0 ? form.assignedTo : [userData._id || userData.id], // Support multiple assignees or assign to self
        dueDate: form.dueDate,
        priority: 'medium', // Default priority - you can add this to form later
  ...
  return (
      ...
      <div className="min-h-screen bg-bg-primary py-12 px-4">
        <div className="max-w-2xl mx-auto">
          <div className="bg-bg-card rounded-3xl shadow-card border border-border-primary overflow-hidden">
            {/* Header */}
